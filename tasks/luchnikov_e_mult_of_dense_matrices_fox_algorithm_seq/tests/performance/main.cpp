...
class LuchnikovEMultOfDenseMatrixFoxAlgoritmPerfTestThreads
...
const auto kPerfTaskList = std::tuple_cat(
    ppc::util::MakeAllPerfTasks<InType, LuchnikovEMultOfDenseMatrixFoxAlgoritmSeq>(
...
INSTANTIATE_TEST_SUITE_P(
    FoxAlgorithmBenchmark,
    LuchnikovEMultOfDenseMatrixFoxAlgoritmPerfTestThreads,
    kGtestParams,
    kTestPrinter);
