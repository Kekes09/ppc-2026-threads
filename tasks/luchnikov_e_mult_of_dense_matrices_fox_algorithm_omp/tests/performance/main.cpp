...
const auto kPerfTaskList =
    std::tuple_cat(ppc::util::MakeAllPerfTasks<InType, LuchnikovEMultOfDenseMatrixFoxAlgoritmOMP>(
        PPC_SETTINGS_luchnikov_e_mult_of_dense_matrices_fox_algorithm_omp));
