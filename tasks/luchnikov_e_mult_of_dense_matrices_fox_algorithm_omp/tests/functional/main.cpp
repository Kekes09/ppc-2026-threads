...
#include "luchnikov_e_mult_of_dense_matrices_fox_algorithm_omp/common/include/common.hpp"
...
const auto kTasks = ppc::util::AddFuncTask<LuchnikovEMultOfDenseMatrixFoxAlgoritmOMP, InType>(
    kTestCases, PPC_SETTINGS_luchnikov_e_mult_of_dense_matrices_fox_algorithm_omp);
